    ...
    commitmentCard: [
      {
        ...
        descripton:
          'We believe every home is unique! During our consultation, we’ll take the time to listen to your needs, answer your questions, and recommend the best housemaid for your family. The consultation can take place over the phone, online, or in person—whichever is most convenient for you.',
      },
      {
        title: '2. Choose & Interview',
        descripton:
          'After the consultation, you can review our curated list of housemaids and select the one that best fits your needs. Once chosen, you’ll have the opportunity to interview the maid to ensure they are the right match for your home.',
      },
      {
  ...
  return (
    <div className="steps-maidspage">
      <div className="container flex flex-col items-center justify-center p-32">
        ...
        <p className="mb-10 text-xl">{stepDetails.subHeader}</p>
        <div className="grid w-full grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-3">
          {stepDetails.commitmentCard.map((item, index) => (
            <div
              key={index}
              className="flex h-[300px] flex-col items-center rounded-sm bg-secondary p-6"
            >
